...
2. Search the [existing issues](https://github.com/houyuhang915-sudo/Codex-Skin-Manager/issues) and [open pull requests](https://github.com/houyuhang915-sudo/Codex-Skin-Manager/pulls). If an active change already touches the same files, add to that discussion or split out a smaller change with no overlap.
